...
class TestGameService(unittest.TestCase):
    ...
    def test_check_win_including_piece_returns_false_for_empty_grid(self):
        self.assertFalse(self.game_service.check_win_including_piece(self.game_service.game_grid, 0))
    ...
    def test_check_win_including_piece_returns_true_for_horizontal_win(self):
        ...
        self.assertTrue(self.game_service.check_win_including_piece(self.game_service.game_grid,3))
    ...
    def test_check_win_including_piece_returns_true_for_horizontal_win_2(self):
        ...
        self.assertTrue(self.game_service.check_win_including_piece(self.game_service.game_grid,6))
    ...
    def test_check_win_including_piece_returns_true_for_vertical_win(self):
        ...
        self.assertTrue(self.game_service.check_win_including_piece(self.game_service.game_grid,0))
    ...
    def test_check_win_including_piece_returns_true_for_falling_diagonal_win(self):
        ...
        self.assertTrue(self.game_service.check_win_including_piece(self.game_service.game_grid,4))
    ...
    def test_check_win_including_piece_returns_false_for_three_horizontal_pieces(self):
        ...
        self.assertFalse(self.game_service.check_win_including_piece(self.game_service.game_grid,2))
    ...
    def test_check_win_including_piece_returns_false_for_three_falling_diagonal_pieces(self):
        ...
        self.assertFalse(self.game_service.check_win_including_piece(self.game_service.game_grid,3))
